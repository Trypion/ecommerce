...
const file_proto_user_proto_rawDesc = "" +
	...
	"\n" +
	"DeleteUser\x12\x17.user.DeleteUserRequest\x1a\x18.user.DeleteUserResponseB\x16Z\x14ecommerce/proto/userb\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	...
	0,  // 2: user.DeleteUserResponse.user:type_name -> user.User
	...
	9,  // 6: user.UserService.CreateUser:input_type -> user.CreateUserRequest
	...
	8,  // 10: user.UserService.Login:output_type -> user.LoginResponse
	10, // 11: user.UserService.CreateUser:output_type -> user.CreateUserResponse
	2,  // 12: user.UserService.GetUser:output_type -> user.GetUserResponse
	4,  // 13: user.UserService.UpdateUser:output_type -> user.UpdateUserResponse
